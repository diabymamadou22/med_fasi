...
import { X, Ticket, Sparkles, Heart } from 'lucide-react';
...
export const AddVoucherModal: React.FC<AddVoucherModalProps> = ({
  ...
  const [colorGradient, setColorGradient] = useState('from-rose-500 to-pink-600');
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-end gap-2 pt-2">
            ...
            <button
              type="submit"
              className="px-5 py-2 rounded-xl bg-rose-500 hover:bg-rose-600 text-white text-xs font-bold shadow-md flex items-center gap-1.5"
            >
              <Ticket className="w-3.5 h-3.5" />
              <span>Offrir ce Bon d'Amour</span>
            </button>
          </div>
        </form>
      </motion.div>
